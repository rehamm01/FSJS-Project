...
const FILES = [
  { 
    id: 'a', 
    title: 'Between the leaves and in the bed', 
    artist: 'Ebony G. Patterson', 
    imageLarge: '', 
    imageSmall: '', 
    year: '2015', 
    media: 'Photo, paper and embellishments', 
    category: 'Contemporary Art, 1980-Present', 
    museum: 'KMAC'
  },
  ...
  { 
    ...
    artist: 'Pieke Bergmans', 
    imageLarge: '', 
    imageSmall: '', 
    year: '2012', 
    media: 'Steel, hand-blown glass, electronics', 
    category: 'Contemporary Art, 1980-Present', 
    museum: '21c Lexington'
  },
  
  { 
    id: 'c', 
    title: 'Waiting (L’Attente)', 
    artist: 'Marc Chagall', 
    imageLarge: '', 
    imageSmall: '', 
    year: '1967', 
    media: 'Oil on canvas', 
    category: 'European and American Art, 1945-1980', 
    museum: 'Speed Art Museum'
  },

  { 
    id: 'd', 
    title: 'Priscilla Johnston', 
    artist: 'Alice Neel', 
    imageLarge: '', 
    imageSmall: '', 
    year: '1966', 
  ...
  { 
    id: 'e', 
    title: 'Portrait of Madame Adélaïde', 
    artist: 'Adélaïde Labille‑Guiard', 
    imageLarge: '', 
    imageSmall: '', 
    year: 'c 1787', 
    media: 'Oil on canvas', 
    category: 'European Art, 1700-1800', 
    museum: 'Speed Art Museum'
  },

  {
    ...
    imageSmall: '', 
    year: '2005', 
    media: 'Steel, fiberglass, paint', 
    category: 'Contemporary Art, 1980-Present', 
    museum: '21c Louisville'
  },
  
  { 
    id: 'g', 
    title: 'Portrait of Mademoiselle Duclos in the Role of Ariadne', 
...
router.get('/file', function(req, res, next) {
  ...
  if (term) {
    query.$or = [
      ...
      { imageLarge: new RegExp(term, 'ig'), },
      { imageSmall: new RegExp(term, 'ig'), },
...
const fileId = req.params.fileId;
  ...
  File.findById(fileId, function(err, file) {
    ...
    file.imageLarge = req.body.imageLarge;
    file.imageSmall = req.body.imageSmall;
